...
<div class="container-fluid">
    ...
    <form method="post" id="create_form">
        <div class="form-group">
            <input type="hidden" name="id" id="id" class="form-control" maxlength="11" value="<?php echo ($info["id"]); ?>" placeholder="Egg Price">

            <label>鸡蛋价格[元/kg]:</label>
            <input type="text" name="egg_price" id="egg_price" class="form-control" value="<?php echo ($info["egg_price"]); ?>" maxlength="11"  placeholder="Egg Price">
        </div>
        <div class="form-group">
            <label>饲料价格[元/kg]:</label>
            <input type="text" name="feed_price" id="feed_price" class="form-control" value="<?php echo ($info["feed_price"]); ?>" maxlength="11"  placeholder="Feed Price">
        </div>
        <div class="form-group">
            <label>日期时间:</label>
            <input type="date" name="delivery_date" class="form-control" value="<?php echo ($info["delivery_date"]); ?>" placeholder="Delivery date">
        </div>
...
<script type="text/javascript">
    ...
    function edit(){
        ...
        url = "<?php echo U('AdminTodayPrice/edit');?>"
