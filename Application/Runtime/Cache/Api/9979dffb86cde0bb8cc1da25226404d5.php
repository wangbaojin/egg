...
<div class="container-fluid">
    ...
    <form method="post" id="create_form">
        ...
        <div class="form-group">
            <label>标题:</label>
            <input type="text" name="title" id="title" value="<?php echo ($info["title"]); ?>" class="form-control"  placeholder="标题">
        </div>
        <div class="form-group">
            <label>原文链接:</label>
            <input type="text" name="article_url" id="article_url" value="<?php echo ($info["article_url"]); ?>" class="form-control"   placeholder="原文链接">
        </div>
        <div class="form-group">
            <label>摘要:</label>
            <textarea class="form-control" name="abstract" id="abstract"><?php echo ($info["abstract"]); ?></textarea>
        </div>
        <div class="form-group">
            <label>发布时间:</label>
            <input type="datetime" name="newstime" id="newstime" value="<?php echo ($info["newstime_date"]); ?>" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD 00:00:00'})" class="layui-input form-control" value="<?php echo ($info["newstime"]); ?>" placeholder="发布时间">
        </div>
        <div class="form-group">
            <label>封面:</label>
            <input type="file" name="news_cover" id="news_cover" placeholder="封面">
            <img src="<?php echo ($info["news_cover"]); ?>" width="100px" alt="未上传">
        </div>
        <div class="form-group">
            <label>文章来源:</label>
        ...
        <div class="form-group">
            <label>是否置顶:<input type="checkbox" <?php if($info['top_num'] == 1): ?>checked<?php endif; ?> name="top_num" id="top_num" class="" ><br><small>[选择后该文章将会置顶]</small><br></label>
        </div>
