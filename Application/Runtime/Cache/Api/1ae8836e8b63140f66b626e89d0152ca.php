...
<div class="container-fluid">
    <form class="form-inline" name="searchForm" action="/AdminChickenOrder/index.html" method="get">
        ...
        <table class="table">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="warning" style="padding: 10px"><?php echo ($vo["goods_info"]); ?><br><hr>
                        <?php echo ($vo["chicken_batch"]["breed"]); ?> <br>
                        <?php echo ($vo["chicken_batch"]["coop_name"]); ?><br>
                        <?php echo ($vo["chicken_batch"]["name"]); ?><br>

                    </td>
                    <td class="active" style="padding: 10px">
                        <img src="<?php echo ($vo["user_info"]["pic"]); ?>" width="100px"><br>
