	...
	<div class="order" v-title='"订单信息"'>
        ...
        <div class="wechatpay">
        	<div class="total">
        		<span>合计：</span>
        		<span>￥</span>
        		<input type="number" name="" value="168.8" readonly="readonly">
        	</div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    $.ajax({
        type: "get",
        url: "http://wechat.jiagehao.cn/EggcoinChicken/buyChicken",
        // url:"./data.json",
        dataType: "json",
        success: function(data){
         	console.log(data);
         	var id=data.result.data.id
         	var order_sn = data.result.data.order_sn
    ...
    $(".pay").on('click',function(){
		datainfo={
	        ...
	        'chicken_batch':this.id,
	        'chicken_type':$.cookie('id')
		}
        $.ajax({
            type: 'POST',
            url: 'http://wechat.jiagehao.cn/EggcoinChicken/confirmBuyChicken',
            data:datainfo,
            dataType: 'json',
            success:function(data){
