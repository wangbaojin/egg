		...
		<div id="option" name="option" style="overflow: visible;" scrolling="no" frameborder="no" width="100%" height="100%">
			...
			<form class="form-horizontal" id="create_form">
				<div class="form-group">
					...
					<div class="col-sm-10"  style="display: flex;">
						<select type="text" name="come_from" id="c_vo" class="form-control" style="width:150px;margin-right: 10px;">
							<option>--请选择--</option>
							<?php if(is_array($come_from)): $i = 0; $__LIST__ = $come_from;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c_vo): $mod = ($i % 2 );++$i;?><option><?php echo ($c_vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					<label >图片</label>
					<div class="col-sm-10">
						<input type="file" type="file" name="news_cover" id="news_cover" value="<?php echo ($info["newstime"]); ?>">
