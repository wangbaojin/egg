	...
	<div class="layui-body">
		...
		<div id="option" name="option" style="overflow: visible;" scrolling="no" frameborder="no" width="100%" height="100%">
			...
			<form class="form-horizontal" id="create_form">
				...
				<div class="form-group">
		            <label>结算日期<?php if($chicken_batch['guess_age_in_days']): ?>今日日龄提示:<?php echo ($guess_age_in_days); endif; ?></label>
		            <div class="col-sm-10">
		        ...
		        <div class="form-group">
					<label>当日蛋价</label>
					<div class="col-sm-10">
						<input  type="text" name="today_egg_price" id="today_egg_price" class="form-control" placeholder="">
						<span>元/kg</span>
					</div>
				</div>
				<div class="form-group">
					<label>当日饲料价格</label>
					<div class="col-sm-10">
						<input  type="text" name="today_feed_price" id="today_feed_price" class="form-control" placeholder="">
						<span>元/kg</span>
					</div>
				</div>
				<div class="form-group">
					<label>当日总死淘数</label>
					<div class="col-sm-10">
						<select type="number" name="death" id="death" value="0"  placeholder="死淘" class="form-control" style="width:200px;margin-right: 10px;">
							<option>1</option>
							<option>2</option>
							<option>3</option>
							<option>4</option>
				...
				<div class="form-group">
					<label>当日总投料重量</label>
					<div class="col-sm-10">
						<select type="number" name="feed_weight" id="feed_weight" class="form-control"   placeholder="投料" style="width:200px;margin-right: 10px;">
							<option>1</option>
							<option>2</option>
							<option>3</option>
							<option>4</option>
